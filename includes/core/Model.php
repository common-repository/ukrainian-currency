...
class MXERU_Model
{
	...
	* Table name
	*/
	protected $table = MXERU_TABLE_SLUG;
	...
	*/
	public function mxeru_get_row( $table = NULL, $wher_name, $wher_value )
	{
	...
	*/
	public function mxeru_get_results( $table = false, $wher_name = NULL, $wher_value = 1 )
	{
